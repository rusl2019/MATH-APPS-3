...
<div class="mt-14">
	...
	<div class="mt-2 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
		<h1 class="text-xl font-semibold text-gray-900 dark:text-white mb-4"><?php echo $title; ?> Data</h1>

		<table id="lecturerDB" class="cell-border w-full text-sm text-left text-gray-900 dark:text-white">
			<thead>
				<tr>
					<th>NIP</th>
					<th>Nama</th>
